...
- **Live availability check (Mike, CTMA booking engine, 2026-07-02):** CaM→Souris 7:00a sailings (the **reverse direction** from Plan A's outbound — checked by accident, still informative) show vehicle space **available Sun Jul 19 & Tue Jul 21 but SOLD OUT Mon Jul 20**; cabins sold out on all three (irrelevant — daytime crossings). Confirms scarcity is real-but-spotty and late-July booking is still open. **Plan A's actual legs remain UNCHECKED:** Souris→CaM Mon Jul 20 (~1:00p) and CaM→Souris Fri Jul 24 (7:00a) — verify both directions/dates and book.
